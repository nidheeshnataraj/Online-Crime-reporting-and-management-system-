...
<head>
    ...
    header("location:userlogin.php");
        ...
        $u_id=$_SESSION['u_id'];
        $res1="SELECT a_no FROM user where u_id='$u_id'";
    ...
    if(isset($_POST['s2']))
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $resu="SELECT a_no FROM complaint where c_id='".mysqli_escape_string($con,$cid);
			$res2=mysqli_query($con,$resu);
            $qn=mysqli_fetch_assoc($res2);
