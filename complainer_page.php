...
if(isset($_POST['s'])){
    ...
    if($var>=0)
    {
      ...
      $query="insert into complaint(a_no,location,type_crime,d_o_c,description) values('$a_no','$location','$type_crime','$d_o_c','$description')";
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
				...
				<div class="top-w3-agile" style="color: gray">Location of Crime
                    ...
                    <select class="form-control" name="location">
						<?php
                        $loc="select location from police_station";
                        $res=mysqli_query($con,$loc);
...
<div style="position: relative;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Crime Portal 2019</b></h4>
</div>
